...
<?php
	...
	echo"<h1 align='center'>Add-on Stock</h1>";
    ...
    echo"<br /><input type='text' id='book_name' name='book_name' placeholder='Book Name' value='".$row['book_name']."'; size='50' readonly>";
	
	echo"<br /><br /><label>Book Author:</label>";
    echo"<br /><input type='text' id='book_author' name='book_author' placeholder='Book Author' value='".$row['book_author']."' size='50' readonly>";
	
	echo"<br /><br /><label>Publication Date:</label>";
    echo"<br /><input type='date' id='book_date' name='book_date' placeholder='Publication Date' max='$current_date' value='".$row['book_date']."' size='50' readonly>";
	...
	echo"<br /><textarea rows = '5' cols = '48' id='book_description' name='book_description' placeholder='Book Description' readonly>".$row['book_description']."</textarea>";
	
	echo"<br /><br /><label>Book Category:</label>";
    echo"<br /><input type='text' id='book_category' name='book_category' placeholder='Book Category' value='".$row['book_category']."' size='50' readonly>";
	...
	echo"<br /><input type='range' min='1' max='20' value='1' name='addon_book_quantity' id='addon_book_quantity' onchange='showRangeValueAddonQuantity(this.value)' >";
	echo"<input type='text' id='addon_quantity' value='1' readonly>";
...
?>
	...
	<script>
		...
		function showRangeValueAddonQuantity(val){
			document.getElementById('addon_quantity').value=val;
		}
	</script>
